...
BASE_URL="https://sctiuenf.com.br/api"
...
create_all_activities() {
    ...
    create_activity "Manutenção Preventiva de Hardware" "Nesse minicurso aprenderemos como realizar uma manutenção preventiva em um computador, com uma prática de troca de pasta térmica, reforçando conceitos básicos sobre hardware e boas práticas no manejo dos componentes." "Daniel Vasconcelos" "INF-1" "minicurso" "2025-09-04T08:30:00-03:00" "2025-09-04T12:00:00-03:00" false 20 false true "easy" "" && ((success_count++))
    ((total_count++))
