...
type Event struct {
	...
	Attendees  []User     `gorm:"many2many:event_users;constraint:OnDelete:CASCADE" json:"atendees"`
	Activities []Activity `gorm:"foreignKey:EventID,EventSlug;references:ID,Slug;constraint:OnDelete:CASCADE" json:"activities"`
	//Implement safely
